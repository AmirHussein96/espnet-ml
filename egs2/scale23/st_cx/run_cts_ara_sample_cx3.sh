...
src_lang=ara    #ara, cmn, kor, rus, spa
tgt_lang=eng
...
#st_config=conf/tuning/train_st_ctc_conformer_asrinit-cts-ara_context_src4k_batch100_lr0.001.yaml
#st_config=conf/tuning/train_st_ctc_conformer_asrinit-cts-ara_context2_batch100_lr0.002.yaml
st_config=conf/tuning/train_st_ctc_conformer_asrinit-cts-ara_context_batch100_lr0.001.yaml
inference_config=conf/tuning/decode_st_conformer_ctc0.4.yaml
...
./st.sh \
    --context "true" \
    --prev_context_tgt_type context3 \
    --audio_format "flac.ark" \
	--text_prev_apply_prob 0.2 \
    --nj 100 \
	--stage 10 \
	--stop_stage 13 \
	--ngpu 2 \
    ...
    --expdir exp_${domain}_${src_lang}_context3 \
