...
from espnet2.st.espnet_model_cx import ESPnetSTModel
from espnet2.tasks.abs_task import AbsTask
from espnet2.text.phoneme_tokenizer import g2p_choices
from espnet2.torch_utils.initialize import initialize
from espnet2.train.class_choices import ClassChoices
from espnet2.train.collate_fn import CommonCollateFn
from espnet2.train.preprocessor import MutliTokenizerCommonPreprocessorCx
...
class STTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=float,
            default=0,
            help="Probability of randomly decide to include previous context",
        )
        group.add_argument(
            "--md_version",
            type=str,
    ...
    def build_preprocess_fn(
        ...
        if args.use_preprocessor:
            retval = MutliTokenizerCommonPreprocessorCx(
                train=train,
                token_type=[args.token_type, args.token_type, args.src_token_type],
                token_list=[args.token_list, args.token_list, args.src_token_list],
                bpemodel=[args.bpemodel, args.bpemodel, args.src_bpemodel],
                ...
                text_prev_apply_prob = args.text_prev_apply_prob
                if hasattr(args, "text_prev_apply_prob")
                else 0,
                speech_name="speech",
                text_name=["text", "text_prev", "src_text"],
            )
        else:
            retval = None
